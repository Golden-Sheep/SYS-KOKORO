        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="/usuario/editar/{{$usuario->id}}/confirmar">
                            {{ csrf_field() }}
                            @method('PUT')
                            <div class="form-group row">
                                <label class="col-md-4 col-form-label text-md-right">Nome:</label>
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="nome" value="{{$usuario->nome}}" placeholder="Digite seu nome completo" required autocomplete="nome">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="email" class="form-control" name="email" value="{{$usuario->email}}" placeholder="Digite seu email" required autocomplete="email">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="password" class="form-control" name="senha" value="{{$usuario->password}}" placeholder="Digite sua senha" required autocomplete="senha">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="date" class="form-control" value="{{date("Y-m-d", strtotime($usuario->dataNascimento))}}" name="data" required autocomplete="data">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" value="{{$usuario->endereco}}" placeholder="R Biriri 789 - Jardim Real" name="endereco" required autocomplete="endereco">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" placeholder="(18) 0000-1111" value="{{$usuario->telefone}}" name="telFixo" required autocomplete="telFixo">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" placeholder="(18) 90000-1111" value="{{$usuario->celular}}" name="telCelular" required autocomplete="telCelular">
                                </div>
                            </div>
